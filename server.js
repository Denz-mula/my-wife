...
app.get('/ddos', (req, res) => {
  res.sendFile(path.join(__dirname, 'ddos.html'));
});
...
╰──────────`,
      ...
      ...Markup.inlineKeyboard([
        [Markup.button.url('👤 Owner', 'https://t.me/alwayshanzznewbie')],
        [Markup.button.url('📢 Join Channel', 'https://t.me/informationalwayshanzznewbie')]
      ])
    }
  );
});
